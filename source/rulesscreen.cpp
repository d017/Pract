...
QString rulesText2 = "<p>В начале игры у каждого есть <b>2000$</b>, <b>2</b> обычных фабрики, "
                     ...
                     "<p>Далее приоритет (*) переходит к следующему игроку, и если игра ещё не закончена (все не выбыли или не закончились месяцы), начинается новый ход.</p>"

                     "<p>Когда игра заканчивается, подсчитываются деньги каждого игрока, и все его фабрики, ЕС и ГП также переводятся в деньги с такими коэффициентами:</p>"
