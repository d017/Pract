...
void Page1::setupUI()
{
    ...
    connect(slider, &QSlider::valueChanged, this, &Page1::updatePlayerValueLabel);
    connect(nextButton, &QPushButton::clicked, [this]() {
        emit nextClicked(slider->value());
    });
}

void Page1::updatePlayerValueLabel(int value)
{
    PlayerValueLabel->setText(QString("Players: %1").arg(value));
    PlayerValueLabel->setAlignment(Qt::AlignCenter);
    PlayerValueLabel->setStyleSheet(
        "QLabel {"
        "    font-family: 'Courier New', monospace;"
